...
public class ConfigHelper {
    ...
    public static String getJdbcDriver(){
        return PropUtils.getStringValue(CONFIG_PROP, DataConfigStant.SMART_FRAMEWORK_JDBC_DRIVER);
    }

    public static String getJdbcUrl(){
        return PropUtils.getStringValue(CONFIG_PROP, DataConfigStant.SMART_FRAMEWORK_JDBC_URL);
    }

    public static String getJdbcUsername(){
        return PropUtils.getStringValue(CONFIG_PROP, DataConfigStant.SMART_FRAMEWORK_JDBC_USERNAME);
    }


    public static String getJdbcPassword(){
        return PropUtils.getStringValue(CONFIG_PROP, DataConfigStant.SMART_FRAMEWORK_JDBC_PASSWORD);
    }
